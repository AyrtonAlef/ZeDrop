function [dy]=laplace_b_c(s,y,b,c)
%LAPLACE defines the ordinary differential equations to be solved for sessile drops.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Equations present in del Río et al 1997
